...
;(function ( $, window, document, undefined ) {
  ...
  Plugin.prototype = {
    ...
    init: function() {
      ...
      this.button(table,tableSortContainer);
    },
    ...
    search: function (table, tableSortContainer) {
      ...
      if (table.hasClass('table-sort-search')) {
        ...
        var search        = $('<div class="table-sort-search-container"><input class="table-sort-search-input" type="text" placeholder="Buscar..."></div>');
        ...
        if (typeof search.css('height') === 'string') {
          searchEmpty.css('height',search.outerHeight());
        }
    ...
    button: function (table, tableSortContainer) {
      table = $(table);
      if (!table.hasClass('table-sort-show-search-count')) return false;
      var tr              = table.find('tbody tr:gt(0)');
      var searchContainer = tableSortContainer.find('.table-sort-search-container');
      var countBadge      = searchContainer.find('.table-sort-search-new');
      if (countBadge.size() < 1) {
        countBadge =  $('<div class="table-sort-search-new">Agregar</div>');
        countBadge.appendTo(searchContainer);
      }
    }
  };
