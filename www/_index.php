...
<link rel="stylesheet" href="css/global.css?v=5" media="screen" type="text/css"/>
<link rel="stylesheet" href="css/arrows.css?v=5" media="screen" type="text/css"/>
<link rel="stylesheet" href="css/tuto.css?v=5" media="screen" type="text/css"/>
...
<?php
    ...
    ?>
<link rel="stylesheet" href="css/admin.css?v=5" media="screen" type="text/css"/>
    <?php
    }
?>

<link rel="stylesheet" href="css/boutons.css?v=5" media="screen" type="text/css"/>
<link rel="stylesheet" href="css/inputs.css?v=5" media="screen" type="text/css"/>

<link rel="stylesheet" href="vendor/chosen.css?v=5" media="screen" type="text/css"/>
<link rel="stylesheet" href="css/zebra_dialog_custom.css?v=5" media="screen" type="text/css"/>
<link rel="stylesheet" href="vendor/switchy.css?v=5" media="screen" type="text/css"/>
<link rel="stylesheet" href="vendor/jquery-ui-1.10.3.custom.css?v=5" media="screen" type="text/css"/>
<link rel="stylesheet" href="vendor/tooltipster.css?v=5" media="screen" type="text/css"/>
...
<script src="js/queue.js?v=5"></script>
<script src="js/dragdrop.js?v=5"></script>
<script src="js/store.js?v=5"></script>
<script src="js/dialogues.js?v=5"></script>
<script src="js/params.js?v=5"></script>
<script src="js/tuto.js?v=5"></script>
...
<script src="js/admin/mondes.js?v=5"></script>
<script src="js/admin/profil.js?v=5"></script>
    <?php
    }
?>
